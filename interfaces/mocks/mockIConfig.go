...
func (m *MockIConfig) GetProfile() interfaces.IProfile {
	m.ctrl.T.Helper()
...
func (mr *MockIConfigMockRecorder) GetProfile() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProfile", reflect.TypeOf((*MockIConfig)(nil).GetProfile))
}

// GetProfileByName mocks base method
func (m *MockIConfig) GetProfileByName(profilename string) (interfaces.IProfile, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIConfigMockRecorder) GetProfileByName(profilename interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProfileByName", reflect.TypeOf((*MockIConfig)(nil).GetProfileByName), profilename)
}
