...
// Source: interfaces/IFileSystemManipulator.go
...
func (m *MockIFileSystemManipulator) CheckOrCreateParentFolder(path string, permissions os.FileMode) {
	m.ctrl.T.Helper()
...
func (mr *MockIFileSystemManipulatorMockRecorder) CheckOrCreateParentFolder(path, permissions interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckOrCreateParentFolder", reflect.TypeOf((*MockIFileSystemManipulator)(nil).CheckOrCreateParentFolder), path, permissions)
}
...
func (m *MockIFileSystemManipulator) LoadBootConfig() *interfaces.Bootconfig {
	m.ctrl.T.Helper()
...
func (mr *MockIFileSystemManipulatorMockRecorder) LoadBootConfig() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadBootConfig", reflect.TypeOf((*MockIFileSystemManipulator)(nil).LoadBootConfig))
}
